      ...
      <div className="py-10">
        <div className="navbar shadow-sm bg-[#396961] w-[96%] mx-auto rounded-xl p-5 z-50 sticky top-10">
          ...
          <div className="navbar-end flex items-center gap-4 text-xl text-white">
            {/* Log in Button */}
            <button
              className="flex items-center gap-2 px-4 py-2 text-white font-medium rounded-full bg-transparent hover:bg-yellow-500 hover:text-black transition"
            ...
            <NavLink
              to="/cart"
              className="lg:flex hidden items-center gap-2 bg-white text-black px-4 py-2 rounded-full hover:bg-gray-200 transition"
            >
