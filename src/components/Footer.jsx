      ...
      <div className="mx-auto flex flex-col gap-10 pb-6">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-between">
          ...
          <div className="flex-1 min-w-[250px]">
            ...
            <div className="mt-7">
              <h3 className="font-bold text-white mb-3 text-lg">{t('footer.stayConnected')}</h3>
          ...
          <div className="flex-1 min-w-[300px] flex justify-center items-center">
            <div className="bg-[#232324] rounded-2xl p-7 w-full max-w-md flex flex-col justify-center items-start">
              <h3 className="text-xl font-bold text-white mb-2">{t('footer.becomeVendor.title')}</h3>
              <p className="text-gray-300 mb-4">{t('footer.becomeVendor.description')}</p>
              <button className="bg-[#F5D377] text-[#191A1A] font-bold text-lg py-2 px-8 rounded-full hover:bg-amber-300 transition">{t('footer.becomeVendor.button')}</button>
            </div>
          </div>
          {/* Right - Newsletter */}
          <div className="flex-1 min-w-[300px]">
            <h3 className="text-xl font-bold text-white mb-4">{t('footer.newsletter.title')}</h3>
        ...
        <div className="border-t border-[#232324] pt-4 flex flex-col md:flex-row justify-between items-center mt-6">
          <div className="flex gap-2">
            <button 
              className={`border rounded-lg px-4 py-2 flex items-center text-white gap-2 transition ${
                currentLanguage === 'de' 
                  ? 'border-[#396961] bg-[#396961]' 
                  : 'border-[#393939] bg-[#191A1A] hover:bg-[#232324]'
              }`}
            ...
            >
              <img src="https://flagcdn.com/24x18/gb.png" alt="EN" className="w-6 h-4 mr-2" />
              English
            </button>
          </div>
